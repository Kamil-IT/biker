...
DATABASE_URL from the environment or searcher/.env. The last step performs ONE
real OLX search through the claude CLI (Trek Marlin 5, ~1–2 min with the
Playwright photo scrape) and checks the rows it wrote in the database.
"""
import json
import os
import sys
